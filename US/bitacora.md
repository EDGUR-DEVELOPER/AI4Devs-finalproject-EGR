...
- [x] **US-AUTH-006**: Manejo de sesión expirada
        - [x] **US-AUTH-006**: Manejo de sesión expirada
...
- [x] US-AUTH-006 completado: Manejo de sesión expirada implementado en frontend. Interceptor Axios, limpieza de estado, redirección a login y alerta UX funcional.
