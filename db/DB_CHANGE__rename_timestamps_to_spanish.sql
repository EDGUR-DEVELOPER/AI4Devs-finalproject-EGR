...
-- -----------------------------------------------------------------------------
-- 2. Recrear función con nomenclatura española
-- -----------------------------------------------------------------------------
...
COMMENT ON FUNCTION actualizar_fecha_actualizacion IS 
    'Actualiza automáticamente fecha_actualizacion en tabla usuarios';

-- -----------------------------------------------------------------------------
-- 3. Recrear trigger con nuevo nombre
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 4. Eliminar función antigua (opcional - limpieza)
-- -----------------------------------------------------------------------------
