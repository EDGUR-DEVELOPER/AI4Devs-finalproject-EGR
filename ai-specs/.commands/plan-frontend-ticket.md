...
2. Analyze the ticket mentioned in #ticket using the MCP. If the mention is a local file, then avoid using MCP
...
Markdown document at the path `ai-specs/changes/[id]_frontend.md` containing the complete implementation details.
