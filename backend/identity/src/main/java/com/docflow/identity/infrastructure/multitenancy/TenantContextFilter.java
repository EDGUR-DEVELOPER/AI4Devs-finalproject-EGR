 ...
 * 
 * ORDEN DE FILTROS: Este filtro debe ejecutarse DESPUÉS del JwtAuthenticationFilter
 * para que el SecurityContext ya esté poblado si es necesario.
 * 
...
public class TenantContextFilter extends OncePerRequestFilter {
     ...
     * 
     * Por defecto se ejecuta para TODAS las peticiones, pero puede personalizarse
     * para excluir endpoints públicos (health checks, Swagger UI, etc.)
     * 
